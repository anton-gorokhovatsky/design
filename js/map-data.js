...
const mapItems = [
  ...
  },
  {
    ...
    description: "Сайт велопроекта Виктора Доронина: 11 111 км за 31 день в декабре 2026 года. Хотелось дать почувствовать место заезда, поэтому я связал оформление со светом и погодой трассы в Дубае. Утром появляются песочные оттенки, днём поверхности светлеют, на закате свет становится золотистым, ночью — холодным голубым. Облачность, жара, ветер и пыль по данным прогностических моделей меняют атмосферу страницы.",
    timeYear: 2026,
