...
const mapItems = [
  ...
  },
  {
    ...
    description: "В «Медведе» звучит предельно точная формула сервиса: сделать всё так, чтобы гость буквально охренел. Не от трюка, а от внимания — когда человека действительно заметили и каждая деталь сложилась именно для него. В этом для меня сходятся еда, сервис и дизайн: не показать, как ты старался, а дать человеку почувствовать, что всё это было сделано для него.",
