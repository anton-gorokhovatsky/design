...
const mapItems = [
  ...
  },
  {
    ...
    description: "В «Медведе» цель сервиса формулируют без церемоний: сделать так, чтобы гостям буквально снесло крышу. Не от эффектного трюка, а от точности внимания — заметить человека, понять, что для него важно, и выстроить каждую деталь вокруг этого. Для меня здесь сходятся еда, сервис и дизайн: огромная работа остаётся за сценой, а человек чувствует, что всё было сделано именно для него.",
