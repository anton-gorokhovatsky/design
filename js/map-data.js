...
const mapItems = [
  ...
  },
  {
    ...
    description: "Для меня еда — это ещё и сервис: заметить человека и сделать для него чуть больше, чем он ожидал. В «Медведе» это становится формулой: внимание → ремесло → неожиданность → эмоция.",
