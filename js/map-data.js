...
const mapItems = [
  ...
  },
  {
    ...
    kindLabel: "ПРОЕКТ / ГРАФ «ГАРАЖА»",
    previewVideo: "assets/reels/garage-webzine.mp4?v=85c80dcc23b9",
    previewOrientation: "landscape",
  ...
  },
  {
    ...
    previewVideo: "assets/reels/shirokostup.mp4?v=531204f04b89",
    previewOrientation: "landscape",
  ...
  },
  {
    ...
    meta: "МАГАЗИН / TILDA / БЫСТРЫЙ ЗАПУСК",
    description: "Интернет-магазин «Доронин в деле», собранный на базовых инструментах Tilda и запущенный для приёма заказов через час после создания аккаунта.",
    evidence: {
      task: "Быстро и красиво собрать интернет-магазин на базовом инструментарии Tilda, чтобы начать принимать заказы через час после создания аккаунта.",
      role: "Структура, визуальная сборка и настройка магазина средствами базового инструментария Tilda.",
      result: "Через час после создания аккаунта сайт был запущен и начал принимать заказы.",
    },
