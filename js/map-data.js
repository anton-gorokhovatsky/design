...
const mapItems = [
  ...
  },
  {
    ...
    description: "Сайт Дома Наркомфина с интерактивной моделью здания, световыми состояниями и календарём.",
    timeYear: 2023,
  ...
  },
  {
    ...
    description: "Кураторская практика и архив проектов Ольги Широкоступ в личном портфолио со спокойным редакционным интерфейсом.",
    timeYear: 2026,
  ...
  },
  {
    ...
    description: "Первая концептуальная версия сайта молодой культурной институции Tarski. Сайт будет расти и развиваться вместе с ней.",
    timeYear: 2026,
  ...
  },
  {
    ...
    title: "HERMAN & CO",
    meta: "ПРОФИЛЬ / САЙТ",
    description: "Личный сайт Германа Винокурова — человека, который стрижёт, разбирается в моде и стиле, фотографирует, бегает, играет в футбол и любит музыку.",
    timeYear: 2026,
  ...
  },
  {
    ...
    description: "Сайт предстартового кэмпа в Сочи: программа, тренеры, условия и заявка собраны в ясный маршрут. Визуальная система связывает веб с местом: следует световому дню и откликается на погоду.",
    timeYear: 2026,
  ...
  },
  {
    ...
    description: "Сайт велопроекта Виктора Доронина: 11 111 км за 31 день в декабре 2026 года. На длинных этапах Виктор будет ехать и днём, и ночью. Чтобы передать этот ритм, я связал палитру и тени на сайте с местным временем Дубая. Утром появляются песочные оттенки, днём поверхности светлеют, на закате свет становится золотистым, ночью — холодным голубым. Облачность приглушает свет и смягчает тени, жара снижает насыщенность фонового видео, ветер задаёт движение лёгкой вуали поверх него, а пыль добавляет песочную дымку. Эти эффекты основаны на данных погодных и атмосферных моделей.",
    timeYear: 2026,
  ...
  },
  {
    ...
    title: "KS FISH",
    meta: "КАТАЛОГ / САЙТ",
    description: "Сайт московской «Рыбной лавки капитана Селёдкина» и её владельца Олега Гугунавы. Каталог с актуальными ценами соседствует с «Судовым журналом» — рассказами о рыбе, новых привозах и приготовлении. Море на первом экране задаёт настроение, а фотографии и записи Олега знакомят с жизнью лавки ещё до первого визита.",
    timeYear: 2020,
    href: "https://ks.fish/",
    kindLabel: "ПРОЕКТ / ЧАСТНАЯ ПРАКТИКА",
    previewVideo: "assets/reels/ks-fish.mp4?v=43094c44331a",
    previewPoster: "assets/reel-posters/ks-fish.jpg?v=11f18ffdd39c",
    previewDuration: 14.2,
    previewOrientation: "landscape",
    previewMeta: "ГЛАВНАЯ, ЖУРНАЛ И КАТАЛОГ / 00:14",
    x: 90,
    y: 78,
    size: 13,
  },
  ...
  },
  {
    ...
    linkLabel: "СОБЫТИЯ НА\u00a0САЙТЕ МУЗЕЯ",
  ...
  },
  {
    ...
    linkLabel: "ЧИТАТЬ О\u00a0ДЭЙЛЕ КУПЕРЕ",
    kindLabel: "ЛИЧНОЕ / ИНТЕРЕС",
    x: 58,
    y: 84,
    size: 10,
  ...
  },
  {
    ...
    label: "КЛЕЙТОН ЯНГ",
    title: "КЛЕЙТОН ЯНГ",
    meta: "БЕГ / ВИДЕОДНЕВНИК",
    description: "Сам бегаю пять раз в неделю и с удовольствием слежу за тем, как бегают и как показывают свой бег мои выдающиеся современники. Уже несколько лет с восторгом смотрю видеодневник Клейтона Янга о подготовке к марафонам — от одного марафонского цикла к следующему.",
    href: "https://www.youtube.com/watch?v=WmO14ECRV48",
  ...
  },
  {
    ...
    label: "БЕГ ВРЕДЕН",
    title: "БЕГ ВРЕДЕН",
    meta: "БЕГ / ПУТЕШЕСТВИЯ / ЛЮДИ",
    description: "Бег, поездки на старты и истории людей вокруг спорта. С удовольствием смотрю, как авторы сами проходят дистанции и показывают этот опыт в своих видео.",
    href: "https://www.youtube.com/@BGVRDN",
