...
const mapItems = [
  ...
  },
  {
    ...
    description: "Сайт велопроекта Виктора Доронина: 11 111 км за 31 день в декабре 2026 года. Хотелось дать почувствовать место заезда, поэтому оформление сайта меняется вслед за светом и погодой в Дубае. Утром появляются песочные оттенки, днём поверхности светлеют, на закате свет становится золотистым, ночью — холодным голубым. Облачность приглушает свет и смягчает тени, жара снижает насыщенность фонового видео, ветер задаёт движение лёгкой вуали поверх него, а пыль добавляет песочную дымку. Эти эффекты основаны на данных погодных и атмосферных моделей.",
    timeYear: 2026,
