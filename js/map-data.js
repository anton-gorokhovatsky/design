...
const mapItems = [
  ...
  },
  {
    ...
    description: "Для меня еда — это ещё и сервис: заметить человека и сделать для него чуть больше, чем он ожидал. В «Медведе» это доведено до предела: сделать всё так, чтобы гость почувствовал: этот вечер — именно для него.",
