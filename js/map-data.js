...
const mapItems = [
  ...
  },
  {
    ...
    description: "Сайт предстартового кэмпа в Сочи: программа, тренеры, условия и заявка собраны в ясный маршрут, а солнечный цикл Open‑Meteo мягко меняет температуру выбранной темы.",
    timeYear: 2026,
    timeLabel: "2026",
